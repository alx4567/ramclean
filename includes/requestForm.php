<div class="formContainer">
    ...
    <form method="post" action="" id="request-form" class="form-container">
        ...
        <div class="tab tab-button-container">
            <div class="tablinks commercialBtn" onclick="openTab(event, 'Commercial')">COMMERCIAL</div>
            <div class="tablinks residentialBtn" onclick="openTab(event, 'Residential')">RESIDENTIAL</div>
        ...
        <div id="Residential" class="residential-container tabcontent">
